...
<head>
    ...
    <title>JO d'Hiver | Créer un tour</title>
...
<div class="container mt-5">
  <div class="card shadow border-0">
    <div class="card-body">
      <h2 class="mb-4">➕ Programmer un tour de compétition</h2>
      ...
      <form method="POST" action="{{ route('admin.tours.store') }}">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="titre"
                   ...
                   value="{{ old('titre') }}"
                   placeholder="ex : Qualifications, Demi-finale, Finale"
        ...
        <div class="mb-4">
          ...
          <input type="number" step="0.01" min="0" name="prix"
                 ...
                 value="{{ old('prix') }}" placeholder="45.00" required>
